...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Connect 3 dashboard</title>
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
                                    <a class="menu-link{{ request()->routeIs('admin_dashboard') ? ' active' : '' }}" href="{{ route('admin_dashboard') }}">
                                  ...
                                  <div class="menu-item">
                                    <a class="menu-link{{ request()->routeIs('partner.index') ? ' active' : '' }}" href="{{ route('partner.index') }}">
                                      <span class="menu-icon">
                                        <!-- begin::Svg Icon | path: icons/duotune/abstract/abs027.svg -->
                                        <span class="svg-icon svg-icon-2">
                                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
-->
													...
													<form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
														...
														<div class="d-flex justify-content-end">
															...
															<a href="{{ asset('../../demo1/dist/pages/search/horizontal.html')}}" class="btn btn-sm fw-bolder btn-primary" data-kt-search-element="advanced-options-form-search">Search</a>
														</div>
														<!--end::Actions-->
													</form>
													<!--end::Preferences-->
												...
												<div class="tab-content">
													...
													<div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
														...
														<div class="py-3 text-center border-top">
															<a href="{{ asset('../../demo1/dist/pages/profile/activity.html')}}" class="btn btn-color-gray-600 btn-active-color-primary">View All
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												<img src="{{asset('assets/media/avatars/sohib.jpg')}}" alt="user" />
											</div>
											<!--begin::Menu-->
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="Logo" src="{{ asset('assets/media/avatars/sohib.jpg')}}" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5">Sohaib Alaqad
															<span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pro</span></div>
															<a href="#" class="fw-bold text-muted text-hover-primary fs-7">salaqad@connect3.com</a>
														</div>
														<!--end::Username-->
													</div>
												</div>
													...
													<div class="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="left-start">
														...
														<div class="menu-sub menu-sub-dropdown w-175px py-4">
															...
															<div class="menu-item px-3">
																...
																<span class="symbol symbol-20px me-4">
																	<img class="rounded-1" src="assets/media/flags/palestine.svg" alt="" />
																</span>Arabic</a>
															</div>
															<!--end::Menu item-->
														</div>
										...
										<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
											...
											<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
												...
												<div class="mb-3 mb-md-0 fw-bold">
													...
													<div class="fs-6 text-gray-700 pe-7">Login into Connect3 Admin Dashboard to make sure the data integrity is OK</div>
												</div>
												<!--end::Content-->
												<!--begin::Action-->
						...
						<div class="d-flex justify-content-start mb-10">
							...
							<div class="d-flex flex-column align-items-start">
								...
								<div class="d-flex align-items-center mb-2">
									<!--begin::Avatar-->
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="{{asset('assets/media/avatars/Ahmed.jpg')}}" />
									</div>
									<!--end::Avatar-->
									<!--begin::Details-->
									<div class="ms-3">
		...
		<div id="kt_explore" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'350px', 'lg': '475px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_explore_toggle" data-kt-drawer-close="#kt_explore_close">
			...
			<div class="card shadow-none rounded-0 w-100">
				...
				<div class="card-header" id="kt_explore_header">
					<h3 class="card-title fw-bolder text-gray-700"></h3>
					<div class="card-toolbar">
				...
				<div class="card-body" id="kt_explore_body">
					...
					<div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_explore_body" data-kt-scroll-dependencies="#kt_explore_header" data-kt-scroll-offset="5px">
						...
						<div class="mb-0">
							...
							<div class="mb-7">
								<div class="d-flex flex-stack">
									<h3 class="mb-0">connect3</h3>
									<a href="#" class="fw-bold" target="_blank">FAQs</a>
								</div>
							</div>
							<!--end::Header-->
							<!--begin::License-->
							...
							<div class="rounded border border-dashed border-gray-300 py-4 px-6 mb-5">
								<div class="d-flex flex-stack">
									...
									<div class="text-nowrap">
										<a href="#" class="btn btn-sm btn-success" target="_blank">Contact Us</a>
									</div>
								</div>
							</div>
							<!--end::License-->
