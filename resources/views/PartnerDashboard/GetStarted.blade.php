                    ...
                    <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0"
                        ...
                        <div class="mb-10">
                            ...
                            <div class="fs-2hx fw-bold text-gray-800 text-center mb-13">
                                <span class="me-2">Welcome to Connect 3 We are excited to work with you and change the
                                    world together towards
                                    <br />
                            ...
                            <div class="text-center">
                                <a href='{{ route('documentation') }}' class="btn btn-lg btn-success fw-bold">Get
                                    Started</a>
                            </div>
                            <!--begin::Action-->
                        </div>
                        ...
                        <img class="mx-auto h-150px h-lg-200px theme-light-show"
                            src="{{ asset('assets/media/illustrations/misc/nodes.png') }}" alt="" />
