        ...
        <div class="card-body">
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="badge badge-lg badge-primary">
                    <span id="kt_file_manager_items_counter"> {{$users->count()}} Users</span>
                </div>
                <!--end::Folder Stats-->
            </div>
            <!--end::Table header-->
                            ...
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-250px sorting_disabled" rowspan="1" colspan="1"
                                        style="width: 10%;">User Name
                                    </th>
                                    <th class="min-w-250px sorting_disabled" rowspan="1" colspan="1"
                                    style="width: 25%;">Email
                                    </th>
                                    <th class="min-w-10px sorting_disabled" rowspan="1" colspan="1"
                                        style="width: 10%;padding-right: 70px;">subscriptoin
                                    </th>
                                    <th class="min-w-10px sorting_disabled" rowspan="1" colspan="1"
                                        style="width: 10%;padding-right: 20px;">Country
                                    </th>
                                 ...
                                 <td data-order="Images">
                                     <div class="d-flex align-items-center">
                                         <span>
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#009ef7}</style><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                                        </span>
                                         <a href="#" class="text-gray-800 text-hover-primary ms-6">{{$user->name}}</a>
                                     </div>
                                 </td>
                                 <td data-order="Invalid date">{{$user->email}}</td>
                                 <td>{{$user->subscription}}</td>
                                 <td data-order="Invalid date">{{$user->Country}}</td>
                                         ...
                                         <div class="ms-2">
                                             ...
                                             <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                                 ...
                                                 <div class="menu-item px-3">
                                                     <a href="{{route('users.show', $user->id)}}" class="menu-link px-3">Info</a>
                                                 </div>
                                                 <div class="menu-item px-3">
                                                     <a href="#" class="menu-link text-danger px-3" data-bs-toggle="modal" data-bs-target="#deleteModal{{$user->id}}">Delete</a>
                                                 </div>
                                             </div>
